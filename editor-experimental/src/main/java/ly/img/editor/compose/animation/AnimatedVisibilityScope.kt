...
import ly.img.editor.compose.animation.EnterExitState.PostExit
import ly.img.editor.compose.animation.EnterExitState.PreEnter
import ly.img.editor.compose.animation.EnterExitState.Visible
import ly.img.editor.compose.animation_core.EnterTransition
import ly.img.editor.compose.animation_core.ExitTransition
import ly.img.editor.compose.animation_core.MutableTransitionState
import ly.img.editor.compose.animation_core.Transition
import ly.img.editor.compose.animation_core.createChildTransition
import ly.img.editor.compose.animation_core.createModifier
import ly.img.editor.compose.animation_core.expandHorizontally
import ly.img.editor.compose.animation_core.expandIn
import ly.img.editor.compose.animation_core.expandVertically
import ly.img.editor.compose.animation_core.fadeIn
import ly.img.editor.compose.animation_core.fadeOut
import ly.img.editor.compose.animation_core.shrinkHorizontally
import ly.img.editor.compose.animation_core.shrinkOut
import ly.img.editor.compose.animation_core.shrinkVertically
...
fun AnimatedVisibility(
    ...
    visibleState =
        remember { MutableTransitionState(initiallyVisible) }
            .apply { targetState = visible },
    modifier = modifier,
    enter = enter,
    exit = exit,

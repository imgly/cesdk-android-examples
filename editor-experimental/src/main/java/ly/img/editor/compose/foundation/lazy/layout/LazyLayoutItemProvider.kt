...
): LazyLayoutItemProvider = DefaultLazyLayoutItemsProvider(itemContent, intervals, nearestItemsRange)
 ...
 */
fun DelegatingLazyLayoutItemProvider(delegate: State<LazyLayoutItemProvider>): LazyLayoutItemProvider =

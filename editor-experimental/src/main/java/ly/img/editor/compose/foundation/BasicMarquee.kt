...
private class MarqueeModifier(
    ...
    var animationMode: MarqueeAnimationMode by mutableStateOf(MarqueeAnimationMode.Immediately)
    ...
    suspend fun runAnimation() {
        ...
        withContext(FixedMotionDurationScale) {
            snapshotFlow {
                ...
                if (animationMode == MarqueeAnimationMode.WhileFocused && !hasFocus) return@snapshotFlow null

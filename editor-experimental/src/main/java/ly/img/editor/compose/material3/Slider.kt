...
import ly.img.editor.compose.material3.tokens.SliderTokens
...
private fun SliderImpl(
    ...
    val onValueChangeState =
        rememberUpdatedState<(Float) -> Unit> {
            if (it != value) {
                onValueChange(it)
            }
        }
...
object SliderDefaults {
    ...
    fun colors(
        ...
        activeTickColor: Color =
            SliderTokens.TickMarksActiveContainerColor
                .toColor()
        ...
        inactiveTickColor: Color =
            SliderTokens.TickMarksInactiveContainerColor.toColor()
                .copy(alpha = SliderTokens.TickMarksInactiveContainerOpacity),
        disabledThumbColor: Color =
            SliderTokens.DisabledHandleColor
                .toColor()
        ...
        disabledActiveTickColor: Color =
            SliderTokens.TickMarksDisabledContainerColor
                .toColor()
        ...
        disabledInactiveTickColor: Color =
            SliderTokens.TickMarksDisabledContainerColor.toColor()
                .copy(alpha = SliderTokens.TickMarksDisabledContainerOpacity),
    ): SliderColors =
        SliderColors(

...
package ly.img.editor.compose.animation
...
import ly.img.editor.compose.animation.AnimatedContentScope.SlideDirection.Companion.Down
import ly.img.editor.compose.animation.AnimatedContentScope.SlideDirection.Companion.End
import ly.img.editor.compose.animation.AnimatedContentScope.SlideDirection.Companion.Left
import ly.img.editor.compose.animation.AnimatedContentScope.SlideDirection.Companion.Right
import ly.img.editor.compose.animation.AnimatedContentScope.SlideDirection.Companion.Start
import ly.img.editor.compose.animation.AnimatedContentScope.SlideDirection.Companion.Up
import ly.img.editor.compose.animation_core.AnimationVector2D
import ly.img.editor.compose.animation_core.EnterTransition
import ly.img.editor.compose.animation_core.ExitTransition
import ly.img.editor.compose.animation_core.FiniteAnimationSpec
import ly.img.editor.compose.animation_core.LayoutModifierWithPassThroughIntrinsics
import ly.img.editor.compose.animation_core.Transition
import ly.img.editor.compose.animation_core.VectorConverter
import ly.img.editor.compose.animation_core.VisibilityThreshold
import ly.img.editor.compose.animation_core.createDeferredAnimation
...
import ly.img.editor.compose.animation_core.spring
import ly.img.editor.compose.animation_core.tween
import ly.img.editor.compose.animation_core.updateTransition
...
fun <S> AnimatedContent(
    ...
    content:
        @Composable()
        AnimatedVisibilityScope.(targetState: S) -> Unit,
) {
...
private class SizeTransformImpl(
    ...
    val sizeAnimationSpec: (initialSize: IntSize, targetSize: IntSize) -> FiniteAnimationSpec<IntSize>,
) : SizeTransform {

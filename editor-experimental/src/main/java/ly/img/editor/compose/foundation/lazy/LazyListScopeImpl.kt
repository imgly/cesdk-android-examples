...
import ly.img.editor.compose.foundation.lazy.layout.LazyLayoutIntervalContent
import ly.img.editor.compose.foundation.lazy.layout.MutableIntervalList
...
internal class LazyListScopeImpl : LazyListScope {
    ...
    override fun stickyHeader(
        ...
        val headersIndexes =
            _headerIndexes ?: mutableListOf<Int>().also {
                _headerIndexes = it
            }

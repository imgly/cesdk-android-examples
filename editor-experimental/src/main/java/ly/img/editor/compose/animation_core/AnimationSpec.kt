...
import ly.img.editor.compose.animation_core.AnimationConstants.DefaultDurationMillis
import ly.img.editor.compose.animation_core.KeyframesSpec.KeyframesSpecConfig
...
class KeyframesSpec<T>(val config: KeyframesSpecConfig<T>) : DurationBasedAnimationSpec<T> {
    ...
    override fun <V : AnimationVector> vectorize(converter: TwoWayConverter<T, V>): VectorizedKeyframesSpec<V> {

...
fun ScalePicker(
    ...
    BoxWithConstraints(
        ...
        Canvas(
            ...
            val centerTickEndOffset = centerTickStartOffset.minus(Offset(x = 0f, y = scaleHeight.toPx()))
        ...
        Text(
            text = textToDraw,
            style = textStyle.copy(color = if (roundedCurrentValue == 0) neutralScaleColor else highlightScaleColor),
            modifier = Modifier
...
private fun integerCrossedOrReached(old: Float, new: Float): Boolean {

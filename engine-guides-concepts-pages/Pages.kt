...
suspend fun pages(engine: Engine): PagesGuideSummary = withContext(engine.dispatcher) {
    // highlight-android-pages-create-scene
    ...
    // highlight-android-pages-set-dimensions
    ...
    // highlight-android-pages-create-pages
    ...
    // highlight-android-pages-add-content
    ...
    // highlight-android-pages-page-margins
    engine.block.setBoolean(
        block = firstPage,
    ...
    // highlight-android-pages-title-template
    engine.block.setString(
        block = firstPage,
    ...
    // highlight-android-pages-page-background
    ...
    // highlight-android-pages-find-pages

...
val IconPack.Visibilityoutline: ImageVector
    get() {
        if (_visibilityoutline != null) {
            return _visibilityoutline!!
        }
        _visibilityoutline = Builder(
            name = "Visibilityoutline", defaultWidth = 24.0.dp,
            ...
            path(
                ...
                close()
                moveTo(12.0f, 17.0f)
                curveTo(13.8833f, 17.0f, 15.6127f, 16.504f, 17.188f, 15.512f)
                curveTo(18.7627f, 14.5207f, 19.9667f, 13.1833f, 20.8f, 11.5f)
                curveTo(19.9667f, 9.8167f, 18.7627f, 8.479f, 17.188f, 7.487f)
                curveTo(15.6127f, 6.4957f, 13.8833f, 6.0f, 12.0f, 6.0f)
                curveTo(10.1167f, 6.0f, 8.3873f, 6.4957f, 6.812f, 7.487f)
                curveTo(5.2373f, 8.479f, 4.0333f, 9.8167f, 3.2f, 11.5f)
                curveTo(4.0333f, 13.1833f, 5.2373f, 14.5207f, 6.812f, 15.512f)
                curveTo(8.3873f, 16.504f, 10.1167f, 17.0f, 12.0f, 17.0f)
                close()
            }
        }
            .build()
...
private var _visibilityoutline: ImageVector? = null

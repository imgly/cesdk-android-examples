...
val IconPack.Cloudalertoutline: ImageVector
    get() {
        if (_cloudalertoutline != null) {
            return _cloudalertoutline!!
        }
        _cloudalertoutline = Builder(
            name = "Cloudalertoutline", defaultWidth = 24.0.dp,
            ...
            path(
                ...
                moveTo(21.86f, 12.5f)
                curveTo(21.1369f, 11.6485f, 20.1116f, 11.1107f, 19.0f, 11.0f)
                ...
                curveTo(6.5f, 6.39f, 5.67f, 7.62f, 5.25f, 9.15f)
                curveTo(4.0f, 9.43f, 2.96f, 10.08f, 2.17f, 11.1f)
                curveTo(1.38f, 12.12f, 1.0f, 13.28f, 1.0f, 14.58f)
                ...
                curveTo(3.0f, 13.53f, 3.34f, 12.71f, 4.03f, 12.03f)
                ...
                curveTo(13.38f, 6.0f, 14.56f, 6.5f, 15.54f, 7.46f)
                curveTo(16.5f, 8.44f, 17.0f, 9.62f, 17.0f, 11.0f)
                verticalLineTo(13.0f)
                horizontalLineTo(18.5f)
                curveTo(19.2f, 13.0f, 19.79f, 13.24f, 20.27f, 13.73f)
                curveTo(20.75f, 14.22f, 21.0f, 14.8f, 21.0f, 15.5f)
                curveTo(21.0f, 16.2f, 20.76f, 16.79f, 20.27f, 17.27f)
                close()
                moveTo(11.0f, 15.0f)

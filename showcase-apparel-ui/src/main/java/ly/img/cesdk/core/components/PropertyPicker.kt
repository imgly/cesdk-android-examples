...
import ly.img.cesdk.core.iconpack.Arrowdropdown
...
fun PropertyPicker(
    ...
    Row(
        ...
        CompositionLocalProvider(
            LocalContentColor provides if (enabled) MaterialTheme.colorScheme.primary else MaterialTheme.colorScheme.onSurface.copy(alpha = 0.38f),
        ) {
            Row(

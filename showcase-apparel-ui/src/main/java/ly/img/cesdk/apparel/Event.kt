...
sealed interface Event {
    ...
    data class OnLoadScene(val sceneUriString: String, val height: Float, val insets: Rect) : Event
...
sealed interface BlockEvent : Event {
    object OnChangeFinish : BlockEvent

    //region Layer Events
    object OnUp : BlockEvent
    object OnDown : BlockEvent
    object OnDuplicate : BlockEvent
    object OnDelete : BlockEvent
    object ToTop : BlockEvent
    object ToBottom : BlockEvent

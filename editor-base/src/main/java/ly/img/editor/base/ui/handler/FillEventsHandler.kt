...
fun EventsHandler.blockFillEvents(
    ...
    fun setGradientColorAtIndex(engine: Engine, fillBlock: DesignBlock, index: Int, color: Color) {
    ...
    fun onChangeFillStyle(style: String) {
        ...
        when (fillStyleEnum) {
            ...
            FillType.LinearGradient -> engine.block.setLinearGradientFill(
                block,
                0.5f, 0f,
                0.5f, 1.0f,
            ...
            FillType.RadialGradient -> engine.block.setRadialGradientFill(
                block,
                0.5f, 0.5f,
                0.5f,
                colorStops = colorStops
            ...
            FillType.ConicalGradient -> engine.block.setConicalGradientFill(
                block,
                0.5f, 0.5f,
                colorStops = colorStops
            )

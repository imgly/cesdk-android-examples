 ...
 * give users an idea of where to position elements. Toggling from edit to preview mode allows reviewing the design in
 * the context of the entire t-shirt.
 ...
 * on how to create the object. It is recommended to use the default builder for [ApparelEditor]: [EngineConfiguration.rememberForApparel].
...
fun ApparelEditor(
    ...
    editorConfiguration: EditorConfiguration<*> = EditorConfiguration.rememberForApparel(),

...
import ly.img.editor.core.component.rememberTextStylePresets
 ...
 */
@Composable
fun DesignConfigurationBuilder.rememberInspectorBar() = InspectorBar.remember {
    listBuilder = {
        InspectorBar.ListBuilder.remember {
            ...
            add { InspectorBar.Button.rememberTextStylePresets() } // Text

                ...
                LibraryCategory.Stickers.copy(
                    content = LibraryContent.Stickers.copy(
                        sections = listOf(
                            ...
                            LibraryContent.Section(
                                titleRes = ly.img.editor.core.R.string.ly_img_editor_asset_library_section_hand,
                                sourceTypes = listOf(AssetSourceType.Stickers),
                                groups = listOf("//ly.img.cesdk.stickers.hand/category/hand"),
                                assetType = AssetType.Sticker,
                            ),
                            LibraryContent.Section(
                                titleRes = R.string.ly_img_showcases_asset_library_section_sketches,
                                sourceTypes = listOf(stickersMiscAssetSourceType),
                                groups = listOf("sketches"),
                                assetType = AssetType.Sticker,
                            ),
                            LibraryContent.Section(
                                titleRes = R.string.ly_img_showcases_asset_library_section_tape,
                                sourceTypes = listOf(stickersMiscAssetSourceType),
                                groups = listOf("tape"),
                                assetType = AssetType.Sticker,
                            ),
                            LibraryContent.Section(
                                titleRes = R.string.ly_img_showcases_asset_library_section_marker,
                                sourceTypes = listOf(stickersMiscAssetSourceType),
                                groups = listOf("marker"),
                                assetType = AssetType.Sticker,
                            ),
                            LibraryContent.Section(
                                titleRes = R.string.ly_img_showcases_asset_library_section_3d_stickers,
                                sourceTypes = listOf(stickersMiscAssetSourceType),

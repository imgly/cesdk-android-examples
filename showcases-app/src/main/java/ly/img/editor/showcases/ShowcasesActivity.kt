...
import ly.img.editor.showcases.ui.screens.EditRecordedVideo
            ...
            EditorTheme {
                ...
                NavHost(navController = navController, startDestination = Screen.Catalog.routeScheme) {
                    ...
                    composable(screen = Screen.PhotoUi) {
                        ...
                        PhotoEditor(
                            engineConfiguration =
                                showcasesViewModel.rememberEngineConfigurationForImage(
                    ...
                    composable(screen = Screen.EditRecordedVideo) {
...
sealed class Screen(
    ...
    data object EditRecordedVideo : Screen(
        routeScheme = "edit-recorded-video",
        arguments = listOf(),
    )
...
private fun String.encodeBase64(withPrefix: String = ""): String =
    withPrefix + Base64.encode(this.toByteArray(Charset.forName("UTF-8")))

@OptIn(ExperimentalEncodingApi::class)
private fun String.decodeBase64(ifPrefixed: String = ""): String =
    if (ifPrefixed.isEmpty() || this.startsWith(ifPrefixed)) {
...
@Composable
private fun <T> NavHostController.getParcelable(key: String): T? =

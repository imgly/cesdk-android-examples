...
fun sourceSets(license: String, userId: String) = CoroutineScope(Dispatchers.Main).launch {
    ...
    engine.asset.addLocalSource(sourceId = "my-dynamic-images", supportedMimeTypes = listOf("image/jpeg"))

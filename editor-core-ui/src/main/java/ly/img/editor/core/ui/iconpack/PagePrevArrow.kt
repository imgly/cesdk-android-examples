...
val IconPack.PagePrevArrow: ImageVector
    get() {
        ...
        _pagePrevArrow = Builder(
            name = "PagePrevArrow", defaultWidth = 20.0.dp, defaultHeight =
            21.0.dp, viewportWidth = 20.0f, viewportHeight = 21.0f
        ).apply {
            path(
                fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f, strokeLineCap = Butt, strokeLineJoin = Miter,

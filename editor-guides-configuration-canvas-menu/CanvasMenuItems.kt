...
@Composable
fun rememberCanvasMenuButton(): CanvasMenu.Button {
    return CanvasMenu.Button.remember(
...
@Composable
fun rememberCanvasMenuButtonSimpleOverload(): CanvasMenu.Button {
    return CanvasMenu.Button.remember(
        id = EditorComponentId("my.package.canvasMenu.button.newButton"),
        scope =
            LocalEditorScope.current.run {
...
@Composable
fun rememberCanvasMenuDivider(): CanvasMenu.Divider {
    return CanvasMenu.Divider.remember(
...
@Composable
fun rememberCanvasMenuCustomItem(): CanvasMenu.Item<CanvasMenu.ItemScope> {
    return CanvasMenu.Custom.remember(

...
package ly.img.editor.compose.foundation.pager
...
import ly.img.editor.compose.foundation.gestures.snapping.SnapFlingBehavior
import ly.img.editor.compose.foundation.gestures.snapping.SnapLayoutInfoProvider
import ly.img.editor.compose.foundation.gestures.snapping.calculateDistanceToDesiredSnapPosition
import ly.img.editor.compose.foundation.lazy.LazyList
...
interface PageSize {
     ...
     */
    fun Density.calculateMainAxisPageSize(
        availableSpace: Int,
        pageSpacing: Int,
    ): Int
...
private fun SnapLayoutInfoProvider(
    ...
    return object : SnapLayoutInfoProvider {
        ...
        override fun Density.calculateApproachOffset(initialVelocity: Float): Float {
            ...
            val startPage =
                pagerState.firstVisiblePage?.let {
            ...
            val correctedTargetPage =
                pagerSnapDistance.calculateTargetPage(
                    startPage,
                    targetPage,
                    initialVelocity,
                    pagerState.pageSize,

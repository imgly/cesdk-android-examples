...
import ly.img.editor.compose.foundation.EdgeEffectCompat.distanceCompat
import ly.img.editor.compose.foundation.EdgeEffectCompat.onAbsorbCompat
import ly.img.editor.compose.foundation.EdgeEffectCompat.onPullDistanceCompat
import ly.img.editor.compose.foundation.EdgeEffectCompat.onReleaseWithOppositeDelta
...
@Composable
@OriginallyExpect
internal fun rememberOverscrollEffect(): OverscrollEffect {
...
internal class AndroidEdgeEffectOverscrollEffect(
    ...
    override suspend fun applyToFling(
        ...
        val consumedX =
            if (velocity.x > 0f && leftEffect.distanceCompat != 0f) {
        ...
        val consumedY =
            if (velocity.y > 0f && topEffect.distanceCompat != 0f) {
    ...
    private fun pullBottom(
        ...
        val pullY = scroll.y / containerSize.height
        val consumed =
            -bottomEffect.onPullDistanceCompat(
                -pullY,
                1 - displacementX,
            ) * containerSize.height
        // If overscroll is showing, assume we have consumed all the provided scroll, and return
    ...
    private fun pullLeft(
        ...
        val consumed =
            leftEffect.onPullDistanceCompat(
                pullX,
                1 - displacementY,
            ) * containerSize.width
        // If overscroll is showing, assume we have consumed all the provided scroll, and return
    ...
    private fun pullRight(
        ...
        val pullX = scroll.x / containerSize.width
        val consumed =
            -rightEffect.onPullDistanceCompat(
                -pullX,
                displacementY,
            ) * containerSize.width
        // If overscroll is showing, assume we have consumed all the provided scroll, and return

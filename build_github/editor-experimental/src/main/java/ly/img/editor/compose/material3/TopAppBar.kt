...
import androidx.compose.ui.unit.dp
import ly.img.editor.compose.material3.tokens.BottomAppBarTokens
import ly.img.editor.compose.material3.tokens.FabSecondaryTokens
import ly.img.editor.compose.material3.tokens.TopAppBarLargeTokens
import ly.img.editor.compose.material3.tokens.TopAppBarMediumTokens
import ly.img.editor.compose.material3.tokens.TopAppBarSmallCenteredTokens
import ly.img.editor.compose.material3.tokens.TopAppBarSmallTokens
    ...
    Surface(modifier = modifier.then(appBarDragModifier), color = appBarContainerColor) {
        val height =
            LocalDensity.current.run {
                TopAppBarSmallTokens.ContainerHeight.toPx() + (
